...
- Cada pantalla debe dejar clara una acción principal.
- No mostrar bloques duplicados con la misma información.
- No introducir más de un nivel de acción secundaria visible por bloque.
- Los filtros deben ser cortos, legibles y opcionales.
- Si una vista necesita explicación larga para entenderse, hay que simplificarla.
- Un estado vacío debe explicar qué falta o cuál es el siguiente paso.

## Reglas de copy
- Usar español simple y directo.
- Preferir etiquetas cortas de una a tres palabras.
- Evitar términos como runtime, overview, shell o control plane en la UI si existe una alternativa más clara.
- Los títulos deben describir la tarea del usuario, no la implementación técnica.
- Los textos de ayuda deben ser breves y accionables.
- No usar texto decorativo que no ayude a decidir o actuar.
